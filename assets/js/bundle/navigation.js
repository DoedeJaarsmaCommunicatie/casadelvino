...
function setMobileMenuTop(menu) {
  ...
  const topper = document.querySelector('.header_topper');
  const offset = header.getBoundingClientRect().bottom - document.body.getBoundingClientRect().top;
...
const isOutOfViewport = (elem) => {
  const bounding = elem.getBoundingClientRect(); const
    out = {};
